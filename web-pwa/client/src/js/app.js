...
function dashboardMarkup() {
  ...
  <section class="metric-grid">
    ...
    ${metricCard("رصيد الصندوق", money(dashboard.cashBalance), "wallet", "نقد متاح حاليًا", dashboard.cashBalance)}
  </section>
