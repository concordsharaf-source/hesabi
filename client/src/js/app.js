...
import { createReportPdfFile, printHtmlDocument, shareOrDownloadCustomerAccountPdf, shareOrDownloadReportPdf, shareOrDownloadInvoicePdf, shareOrDownloadPurchaseInvoicePdf } from "./pdf-export.js";
...
function financialReportRows(type = "summary") {
  ...
  const apkRows = getApkReportRows(type, state, { money, amount, dateTime });
...
const reportTitle = (type = "summary") => ({ cash: "تقرير تحليلي شامل لحركة الصندوق", income: "قائمة الدخل", balance: "المركز المالي", trial: "ميزان المراجعة", customers: "تقرير ديون العملاء", suppliers: "تقرير مستحقات الموردين", expenses: "تقرير المصروفات حسب النوع", inventory: "تقرير المخزون والتكلفة", summary: "التقرير التشغيلي العام", ...Object.fromEntries(APK_REPORT_TYPES) }[type] || "التقرير المالي");
